...
<head>
    ...
    <link rel="stylesheet" href="1style.css">    <meta http-equiv="content-type" content="text/html" charset="Windows-1250">
    <title>strona</title>
</head>
    ...
    <div id="srodek">
        <div id="all">
            ...
            if (isset($_GET['a'])) {
                ...
                echo '<tr>' . "<td>frazę:</td><td> ''" . $wyszukiwanie . "''</td><td>Znaleziono: ". "<td>".$a ." wyników wyszukiwania</td> </tr>";
                echo "</table>";
                if ($a == 0) {
                    echo "<h1>Brak wyników.Wpisz nowe hasło lub skontaktuj sie z administratorem w zakładce kontakt";
                }
                mysqli_close($baza);
            }
            ?>
